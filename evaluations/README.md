...
| `stage2_mdf_lang_script_eval/` | Stage 2 MDF evaluation, **end-to-end condition** — Stage 2 fed each experiment's own predicted Stage 1 text rather than the gold transcriptions | `mudidi benchmark evaluate stage2 --pred-root outputs/benchmark/stage-2-e2e --all-experiments -o evaluations/stage2_mdf_lang_script_eval` |
